...
public class MusicView {
	...
	public void fileSave() {
		// 컨트롤러에게 파일 저장을 요청하고
		// 결과에 따라 "완료", "실패" 출력
		if(mc.fileSave() == 1) System.out.println("파일 저장이 완료되었습니다.");
		else System.out.println("파일 저장이 실패하였습니다.");
	}
	...
	public void searchMusic() {
		...
		System.out.print("검색 할 곡명 : ");
		String title = sc.nextLine();
		
		Music m = mc.searchMusic(title);
		
		if (m == null) System.out.println("검색 실패");
		else System.out.println(m + "을(를) 검색했습니다.");
	}
	
	public void removeMusic() {
		System.out.println("****** 특정 곡 삭제 ******");
		System.out.print("삭제 할 곡명 : ");
		String title = sc.nextLine();
		
		Music m = mc.removeMusic(title);
		
		if (m == null) System.out.println("삭제 실패");
		else System.out.println(m + "을(를) 삭제했습니다.");
	}
	...
	public void setMusic() {
		...
		System.out.print("검색 할 곡명 : ");		
		String title = sc.nextLine();
		System.out.print("수정 할 곡명 : ");		
		String newTitle = sc.nextLine();
		System.out.print("수정 할 곡명 : ");		
		String singer = sc.nextLine();
		
		Music m = mc.setMusic(title, new Music(newTitle, singer));
		
		if (m == null) System.out.println("수정 실패");
		else System.out.println(m + "의 값이 변경되었습니다.");
		
	}
	
	public void ascTitle() {
		int sort = mc.ascTitle();
		
		if (sort == 1) System.out.println("정렬 성공");
		else System.out.println("정렬 실패");
		
	}
	
	public void descSinger() {
		int sort = mc.descSinger();

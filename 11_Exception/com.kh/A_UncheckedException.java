...
public class A_UncheckedException {
	...
	public void test1()	{
		...
		try {
			...
			// printStackTrace() => 예외 정보, 발생 지점을 출력해주는 메소드 (반환형:void)
//			e.printStackTrace();
		}
	...
	public void test3() {
		...
		// 상속 관계인 경우 문법상 부모 타입이 반드시 자식 타입보다 아래에 와야함 
		} catch (RuntimeException e) {
			System.out.println("[Exception] 배열 크기가 음수이거나, 실행 중 어떠한 에러 발생했다...");
			e.printStackTrace();
		}
		// => 여러 개의 catch 블록으로 예외 처리 시
		//	  해당 예외 클래스 간의 상속 관계가 있는 경우,
		//	  부모 타입보다 자식 타입이 먼저(위쪽) 작성되어야 함!
	}
}

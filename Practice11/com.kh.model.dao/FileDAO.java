...
public class FileDAO {
	 ...
	 * 해당 파일이 실제 경로에 존재하는지 여부(exists())를 boolean 으로 반환
	 * @param file 파일 경로
	 ...
	 * String 내용을 파일에 기록(Output)하여 저장
	 * @param file 파일 경로
	 * @param s	저장할 내용
	 */
	 ...
	 * 내부에 저장된 데이터들을 읽어와 하나의 String으로 반환
	 * @param file 파일 경로
	 * @return 읽어온 내용
	 */
	 ...
	 * (FileWriter의 append 모드)될 수 있도록 구현
	 * @param file 파일 경로
	 * @param s 새로운 내용(추가 될 내용)
	 */

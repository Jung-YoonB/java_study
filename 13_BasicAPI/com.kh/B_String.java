...
//		test1();
	...
	public static void test1() {
		...
		// str1 이 가리키고 있는 주소(상수풀)와 "Friday"라는 값 자체가 저장된 주소를 비교
		//		-> 둘 다 같은 곳을 가리키게 됨! (상수풀에 있음)
		...
		// 결과: false
		// 		문자열 객체를 생성해서 값을 대입하게 되면 "heap" 메모리에
		//		새로운 영역에 할당하므로 각각 다른 위치에 값이 저장됨
	...
	public static void test2() {
		...
		// * substring : 문자열.substring(시작 인덱스)
		//				=> 문자열에서 시작인덱스부터 마지막 위치까지 부분을 추출하여 리턴
		//				 문자열.substring(시작 인덱스, 끝인덱스)
		//				=> 문자열에서 시작인덱스부터 끝인덱스 직전까지 부분을 추출하여 리턴
